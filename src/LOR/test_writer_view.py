...
class WriterViewTest(TestCase):
   ...
   def test_view_has_writer_specific_sorted_data(self):
       ...
       # print(response.context['sorted_lors'])
   ...
   def test_accept_button(self):
       ...
       # test that request can be accepted (id=3 has invalid Withdrawn status)
       lor = LOR.objects.get(id=sel_box[2])
       self.assertNotEqual(lor.status, "Accepted")
   ...
   def test_complete_button(self):
       ...
       # test that request can be completed (id=3 has invalid Withdrawn status)
       lor = LOR.objects.get(id=sel_box[2])
       self.assertNotEqual(lor.status, "Completed")
   ...
   def test_deny_button(self):
       ...
       # test that request can be denied (id=3 has invalid Withdrawn status)
       lor = LOR.objects.get(id=sel_box[2])
       self.assertNotEqual(lor.status, "Denied")
